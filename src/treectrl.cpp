...
EWXWEXPORT(wxTreeItemId*,wxTreeItemId_Create)()
{
...
EWXWEXPORT(wxTreeCtrl*,wxTreeCtrl_Create)(wxWindow* _prt,int _id,int _stl)
{
	return new wxTreeCtrl(_prt, _id, wxDefaultPosition, wxDefaultSize, _stl, wxDefaultValidator);
}

EWXWEXPORT(wxTreeCtrl*,wxTreeCtrl_Create2)(wxWindow* _prt,int _id,int _stl)
{
	return new wxTreeCtrl(_prt, _id, wxDefaultPosition, wxDefaultSize, _stl, wxDefaultValidator);
}
...
EWXWEXPORT(wxString*,wxTreeCtrl_GetItemText)(wxTreeCtrl* self,wxTreeItemId* item)
{
