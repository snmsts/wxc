...
EWXWEXPORT(void*,wxTopLevelWindow_GetDefaultButton)(void* self)
{
  return (void*)((wxTopLevelWindow*)self)->GetDefaultItem();
}

EWXWEXPORT(void*,wxTopLevelWindow_GetDefaultItem)(void* self)
{
  return (void*)((wxTopLevelWindow*)self)->GetDefaultItem();
}

EWXWEXPORT(void*,wxTopLevelWindow_GetIcon)(void* self)
{
  static wxIcon tmp = ((wxTopLevelWindow*)self)->GetIcon();
  return (void*)&tmp;
}

EWXWEXPORT(wxString*,wxTopLevelWindow_GetTitle)(void* self)
{
  return new wxString(((wxTopLevelWindow*)self)->GetTitle());
}

EWXWEXPORT(void,wxTopLevelWindow_Iconize)(void* self,bool iconize)
{
...
EWXWEXPORT(wxFrame*,wxFrame_Create)(wxWindow* _prt,int _id,wxString* _txt,long _stl)
{
	return new wxFrame(_prt, _id,*_txt, wxDefaultPosition,wxDefaultSize, _stl);
}
