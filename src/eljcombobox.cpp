...
EWXWEXPORT(wxComboBox*,wxComboBox_Create)(wxWindow* _prt,int _id,wxString* _txt,int _n,void* _str,int _stl)
{
	...
	wxComboBox* result = new wxComboBox (_prt, _id,*_txt, wxDefaultPosition,wxDefaultSize, _n, list, _stl, wxDefaultValidator);
