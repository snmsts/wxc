...
EWXWEXPORT(wxButton*,wxButton_Create)(wxWindow* _prt,int _id,wxString* _txt,int _stl)
{
	return new wxButton (_prt, _id,*_txt, wxDefaultPosition, wxDefaultSize, _stl, wxDefaultValidator);
}
...
EWXWEXPORT(wxBitmapButton*,wxBitmapButton_Create)(wxWindow* _prt,int _id,wxBitmap* _bmp,int _stl)
{
	return new wxBitmapButton (_prt, _id,*_bmp, wxDefaultPosition, wxDefaultSize, _stl, wxDefaultValidator);
}
