...
EWXWEXPORT(void,wxSizerItem_GetRect)(wxSizerItem* self,void* _x,void* _y,void* _w,void* _h)
{
  wxRect r = self->GetRect();
...
EWXWEXPORT(void,wxSizerItem_GetSpacer)(wxSizerItem* self,void* _w,void* _h)
{
  wxSize sz(0,0);
...
EWXWEXPORT(wxSize*,wxGridSizer_CalcMin)(void* self)
{
  return new wxSize(((wxGridSizer*)self)->CalcMin());
}
...
EWXWEXPORT(wxSize*,wxFlexGridSizer_CalcMin)(void* self)
{
  return new wxSize(((wxFlexGridSizer*)self)->CalcMin());
}
...
EWXWEXPORT(wxSize*,wxBoxSizer_CalcMin)(void* self)
{
  return new wxSize(((wxBoxSizer*)self)->CalcMin());
}
	
EWXWEXPORT(int,wxBoxSizer_GetOrientation)(void* self)
{
	return ((wxBoxSizer*)self)->GetOrientation();
}
...
EWXWEXPORT(void,wxStaticBoxSizer_RecalcSizes)(void* self)
{
	((wxStaticBoxSizer*)self)->RecalcSizes();
}
	
EWXWEXPORT(wxSize*,wxStaticBoxSizer_CalcMin)(void* self)
{
  return new wxSize(((wxStaticBoxSizer*)self)->CalcMin());
}
	
EWXWEXPORT(void*,wxStaticBoxSizer_GetStaticBox)(void* self)
{
	return (void*)((wxStaticBoxSizer*)self)->GetStaticBox();
}
...
EWXWEXPORT(void,wxNotebookSizer_RecalcSizes)(void* self)
{
	((wxNotebookSizer*)self)->RecalcSizes();
}
	
EWXWEXPORT(wxSize*,wxNotebookSizer_CalcMin)(void* self)
{
  return new wxSize(((wxNotebookSizer*)self)->CalcMin());
}
	
EWXWEXPORT(void*,wxNotebookSizer_GetNotebook)(void* self)
{
	return (void*)((wxNotebookSizer*)self)->GetNotebook();
}
#endif
