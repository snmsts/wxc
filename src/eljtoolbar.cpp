...
EWXWEXPORT(wxToolBar*,wxToolBar_Create)(wxWindow* _prt,int _id,int _stl)
{
	return new wxToolBar (_prt, _id, wxDefaultPosition, wxDefaultSize, _stl);
}
...
{
  return new wxString(self->GetToolLongHelp (id));
}
...
{
  return new wxString(self->GetToolShortHelp (id));
}
