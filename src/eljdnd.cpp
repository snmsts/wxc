...
{
  return new wxString(((wxTextDataObject*)self)->GetText());
}

EWXWEXPORT(void,TextDataObject_SetText)(void* self,wxString* strText)
{
	((wxTextDataObject*)self)->SetText(*strText);
}
...
{
	return (void*)new ELJDragDataObject(self, _fmt->c_str(), (DataGetDataSize)_func1, (DataGetDataHere)_func2, (DataSetData)_func3);
}
