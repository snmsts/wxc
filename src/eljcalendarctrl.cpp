...
EWXWEXPORT(wxCalendarCtrl*,wxCalendarCtrl_Create)(wxWindow* _prt,int _id,wxDateTime* _dat,int _stl)
{
	return new wxCalendarCtrl (_prt, _id,*_dat, wxDefaultPosition, wxDefaultSize, _stl);
}
