...
EWXWEXPORT(wxDialog*,wxDialog_Create)(wxWindow* _prt,int _id,wxString* _txt,int _stl)
{
	return  new wxDialog(_prt, _id,*_txt, wxDefaultPosition,wxDefaultSize, _stl);
}
