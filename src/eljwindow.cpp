...
EWXWEXPORT(void*,wxWindow_Create)(wxWindow* _prt,int _id,int _stl)
{
	return (void*)new wxWindow(_prt, (wxWindowID)_id, wxDefaultPosition, wxDefaultSize, (long)_stl);
}
...
EWXWEXPORT(int,wxWindow_GetToolTip)(wxWindow* self,void* _buf)
{
...
{
  return new wxSize(self->GetAdjustedBestSize());
}
#else
...
{
  return new wxPoint(self->ClientToScreen( wxPoint(x,y) ));
}
